...
# hyperfine --warmup 1 -n coreutils 'base64 -d -i files/test-small.b64  > /dev/null' -n rust '../target/release/base64 -d -i files/test-small.b64  > /dev/null' --export-markdown results/file-decode-ignore-small.md
